...
public class GroupCreationTests {
    ...
    public void testGroupCreation() {
        ...
        wd.findElement(By.name("group_name")).sendKeys("kirilltest1");
        ...
        wd.findElement(By.name("group_header")).sendKeys("kirilltest2");
        wd.findElement(By.name("group_footer")).click();
        wd.findElement(By.name("group_footer")).clear();
        wd.findElement(By.name("group_footer")).sendKeys("kirilltest3");
